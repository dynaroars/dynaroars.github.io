...
TA is common in the beginning when you haven't found your advisor who would pay you RA. As a TA, you help professors with their classes (e.g., grading). Your TAship is paid through the department, i.e., they hire you to help teach.  During a semester, a TA mgith work with several courses and professors (not necessary their advisor).  TA funding typically is not available during the summer, which has no school.
...
\textbf{How to get Fellowship?} You apply for them.  The US government has many fellowships but these require US citizenship or residency.  However, tech companies including Google, Microsoft, Facebook, IBM all have fellowships that international students can apply for. Fellowship typically requires a research statement, so it is usueful to have some research experience and even publication for a better chance of getting competitive fellowships (remember, you're competiting with all the top Ph.D. students at top universities worldwide). 
