...
\begin{tcolorbox}[left=1pt,right=1pt,top=1pt,bottom=1pt]
Vu: At GMU, we usually decide that a candidate is either (i) admit with funding (TA or RA) or (ii) rejected. In other words, in most cases, we either
...
\paragraph{How to get TA?}  When you apply, you state that you want to be a full time student and need finnancial assistant. The PhD committee will either admit you (and give you GTA), or reject you; i.e., we do not admit a student without supporting them.


%% \item \textbf{How to get it} 
%% \item \textbf{Thought}: But even if you get GRA, you should do GTA at least a semester or two, just to see how teaching is like (and very helpful if you're interested in an academc career).
...
\item *How to get it*?  The common scenario is that you get admitted with TA, and then after a year or two find an advisor who has RA to support you. In some rare (and very lucky) cases you already know some profs  and that prof. will give you RA right away when you start.
...
\begin{tcolorbox}[left=1pt,right=1pt,top=1pt,bottom=1pt]
If you're lucky and got recruited by a prof. who would give you RA right away, it's very likely you will get admitted.  For example, if a prof., even if not in PhD admissin committee, wants to work with and funds you, the PhD admission committee will respect that decision and just admit your application (unless you have many terrible red flags in your application).
\end{tcolorbox}
