...
GMU =         [97242, 50000, 510509, 30000, 1199871, 16000]
GMU_myshare = [97242, 50000, 510509, 30000,  399879, 16000]
GMU_myshare_notpi = []

UNL =         [10000, 174975, 549990, 16000] 
UNL_myshare = [10000, 174975, 158850, 16000]
