...
\vspace{0.2in}
\begin{tcolorbox}[colback=white,colframe=gray,center,boxrule=0.2pt,width=0.98\textwidth]
...
\begin{itemize}
\item TPC, Proceedings of the ACM on Programming Languages (OOPSLA track) \hfill 2024
...
\newcommand{\myunitservices}{
  \begin{itemize}
  \item Member, Executive Committee\hfill 2022--current
