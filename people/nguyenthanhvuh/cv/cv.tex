...
\newcommand{\myemailwork}{\href{mailto:tvn@roars.dev}{tvn@roars.dev}}
\newcommand{\mylab}{\href{https://roars.dev}{roars.dev}}
\newcommand{\mysoftware}{\href{https://code.roars.dev}{code.roars.dev}}
...
\begin{tcolorbox}[enhanced,
    ...
    drop fuzzy shadow]
    \small \textbf{Bio}: \emph{\input{bio-nguyen.txt}}
\end{tcolorbox}
...
\begin{itemize}
    ...
    \begin{description}[before=\small]
        ...
        \item Produced \href{https://roars.dev/bibtex/?q=%23%40nrl&exclude_preprints=true}{\emph{twelve}} peer-reviewed conference and journal papers, and received an \emph{Incentive Award} from the Navy
    \end{description}        
...
\begin{itemize}
    \item \textbf{Amazon Research Award}~[\ref{amz2026ara}] (Trainium Reliable AI), Amazon Science\hfill 2026    
    \item Nominee, GMU Teaching Excellence Award, GMU\hfill 2026
    \item Best Paper Award~[\ref{ishimwe2025llm}], SSBSE\hfill 2025        
    \item Spotlight Paper Award~[\ref{duong2025compositional}], NeurIPS\hfill 2025
    \item Nvidia Academic Grant~[\ref{nvidia2025spark}], NVIDIA\hfill 2025    
    \item \textbf{Most Influential Paper Award}~[\ref{le2011genprog}], IEEE \hfill 2025
        \begin{description}[before=\small]
        \item Named \emph{``One of the most influential papers of TSE's 4th decade''}, Trans. on Software Engineering (TSE)
    \end{description}
...
\begin{itemize}[label={},before=\small]
    \item \textbf{\mygooglescholar{}}: citations 4496, h-index 21, i10-index 34 (as of March 2026).
...
\newcommand{\myjournals}{
  \begin{enumerate}[label=J\arabic*]
    \mypubc{gordio2026iter}{}
    \mypubc{duong2026verifying}{}      
    \mypubc{le2025evolution}{}
    \mypubcc{duong2024harnessing}{25\%}
...
\begin{enumerate}[label=S\arabic*]
    ...
    \end{itemize}
    \item \fullcite{realgmucspeople}
    \item \fullcite{roarsbibtex}
    \item \fullcite{cspicks}
    \item \fullcite{csconfs}    
...
\begin{enumerate}[label=M\arabic*]
  \item \fullcite{gmu2025genprog}  
    \item \fullcite{gmu2025roars}
...
\begin{itemize}
    ...
    \begin{description}[before=\small]
        \item Enrollment 10, Responses 8, Instr. Rating 4.88, Course Rating 4.85 
    \end{description}

  \item \swe{619}\hfill Spring'25
    \begin{description}[before=\small]
        \item Enrollment 25, Responses 15, Instr. Rating 4.8, Course Rating  4.8
    \end{description}
...
\begin{description}[before=\small]
    ...
    \item Co-author of~\ref{li2025destabilizing},~\ref{li2025cooler}
\end{description}
}
...
\begin{description}[before=\small]
    \item First job: A10Networks, Now: Minjiang University
...
\newcommand{\didier}{
\item Didier Ishimwe (PhD, GMU)\hfill graduated, May 2026
\begin{description}[before=\small]
    \item First job: Experian
  \item Co-author of~\ref{ishimwe2025llm},~\ref{ishimwe2022dynaplex},~\ref{ishimwe2021dynaplex},~\ref{nguyen2020using}
\end{description}
}
...
\begin{description}[before=\small]
  \item Co-author of~\ref{duong2026verifying2},~\ref{duong2026verifying},~\ref{duong2025compositional},~\ref{duong2025generating},~\ref{duong2025neuralsat},~\ref{duong2025neuralsat2},~\ref{duong2024harnessing},~\ref{nguyen2022syminfer}
\end{description}
}
...
\newcommand{\phule}{
\item Phu Le (undergrad, NSF REU)\hfill Fall 2025--present
}

\newcommand{\azan}{
\item Muhammad Azan Rasul (undergrad, NSF REU)\hfill Fall 2025--present
}
...
\begin{itemize}
    \item Review Panelist, NSF\hfill 2019--present
    \begin{itemize}
        \item \emph{10+ panels}, \textbf{at least once every year} since 2019, \textbf{7 in 2025}
        \item '26 (on going), '25 (\textbf{7x}\footnote{In 2025, NSF faced many uncertainties and organizational changes, making it difficult to find panelists. So I made an effort to say yes to all invitations aligned with my expertise.}), '24 (4x), '23 (2x), '22 (2x), '21 (1x), '20 (1x), '19 (1x)
    \end{itemize}
  \item Review Panelist, PhD Fellowships (NSF GRFP and DoD NDSEG)
        \begin{description}[before=\small]
          \item Details omitted for confidentiality
        \end{description}
\end{itemize}
...
\begin{itemize}
  \item \textbf{Program Director}, MS Software Engineering\hfill 2023--present
  \item Member, Faculty Performance Evaluation Committee\hfill 2026--present
  \item Member, Web Committee\hfill 2022--present
    \begin{itemize}
        \item Co-Lead CS Web Site Migration Committee\hfill 2024--2005
    \end{itemize}
  \item Co-organizer, Distinguished Lecturer Series\hfill 2025--present      
    ...
    \begin{description}[before=\small]
        ...
        \item Create VOH'22 and 23 websites (\url{https://cs-gmu.github.io/cs-phd-voh-s23/})
    \end{description}
  \item Chair or Member, Ph Comprehensive Exams\hfill 2021--current
    \begin{itemize}
        \item On average chairing 5 comprehensive exams each semester.
    \end{itemize}
...
\begin{itemize}
    ...
    \item Mentor, ORIEI NSF CAREER Cohort\hfill 2024--current
...
\begin{itemize}
    \item Scholarship Judge, Kimmy Long Scholarship Foundation\hfill 2023--present    
    \item  Interviewer, Vietnamese Education Foundation 2.0 (VEF2.0) Fellowship Program\hfill 2023--2025
    \begin{description}[before=\small]
        \item Evaluate applications and interview VEF2.0 fellows for PhD applications in the US
    \end{description}
...
\begin{itemize}
    \item \textbf{Senior Member},  Association for Computing Machinery (ACM) \hfill  2025
    \item \textbf{Senior Member}, Institute of Electrical and Electronics Engineers (IEEE) \hfill 2025
\end{itemize}

\section{Miscellaneous (Non-Professional)}
\begin{itemize}
    \item Citizenship: \textbf{U.S} (DoD Secret Clearance---inactive)
  \item \textbf{Chess coach} for Marshall Elementary School (2025--present)
        \begin{itemize}
            \item Revive Marshall Chess club and coach 25+ students (K-5).
            \item Lead club to multiple 1st-place team finishes and individual medal placements at regional tournaments.
        \end{itemize}
