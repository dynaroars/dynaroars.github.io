...
% \section{Awards and Honors with Students}
...
%     % \end{description}
%     \item \textbf{NeuralSAT} ranked \emph{2nd overall}, VNN-COMP\hfill 2024--2025
%     %\item \textbf{NeuralSAT} ranked \emph{2nd overall}, VNN-COMP\hfill 
...
\section{Research Funding to support Students (RA's and REU's)}
...
%13 -- 17 avg(4.8, 4.8,4.87,4.73, 4.67) = 4.8
%18 -- 20 avg(4.79,4.8,4.71) = 4.8
...
\begin{description}[before=\small]
  \item Co-author of~\ref{duong2025compositional},~\ref{duong2025generating},~\ref{duong2025neuralsat},~\ref{duong2024harnessing},~\ref{nguyen2022syminfer}
  \item \textbf{Spotlight Paper Award}~[\ref{duong2025compositional}], NeurIPS\hfill 2025
\end{description}
}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item GMU: Phu Le, Stefania Piciorea, Huong Bui, James (Phap) Nguyen; Phuong Priscilla Nguyen (Undergraduate, Boston University); Michael Vittori
...
\section{Publication Record with Students}
...
\section{Service Activities related to Student Development}


\subsection{Research Proposal Review}
\begin{itemize}
    % \item Review Panelist, NSF\hfill 2019--present (\emph{10+ panels, \textbf{at least once every year} since 2019})
    % \begin{itemize}
    % \item '25 (\textbf{7x}\footnote{In 2025, NSF faced many uncertainties and organizational changes, which might have made it difficult for program managers to find people willing to serve on panels and further caused delays in reviews. So I made an effort to say ``yes'' to all invitations to panels aligned with my expertise, to support NSF and the U.S. funding landscape (though the trade-off was saying ``no'' to most invitations to conference program committees and journal reviews!).}), '24 (4x), '23 (2x), '22 (2x), '21 (1x), '20 (1x), '19 (1x)
    % \end{itemize}
...
\begin{itemize}
    \item Member, Graduate Committee\hfill 2025--present
...
%     \item Extracurricular: \textbf{Chess} coach for Elementary School (2025--present)
