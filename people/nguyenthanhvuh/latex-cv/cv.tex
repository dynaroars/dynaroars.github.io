...
\begin{itemize}
    ...
    \begin{description}[before=\small]
        \item Three 8-month internships in the Information Technology and Tactical Electronic Warfare divisions
...
\begin{itemize}
  \item \textbf{NeuralSAT}: A high-performance verification tool for Deep Neural Networks. \url{github.com/dynaroars/neuralsat/}
    \begin{itemize}[before=\small]
        ...
        \item ranked \textbf{4th overall} at VNN-COMP'23 and received the ``New Commer Award''
    \end{itemize}
...
\begin{itemize}
    \item Review Panelist, NSF\hfill 2019--current (\emph{total 9, at least once every year since 2019})
