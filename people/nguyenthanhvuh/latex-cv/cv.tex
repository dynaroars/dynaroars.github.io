...
\notcoe{
  ...
  \begin{itemize}
  \item CS695/SWE699: AI Safety and Assurance$^{\dagger}$\hfill Fall'23
  \begin{description}[before=\small]
...
\newcommand{\linhan}{
\item Linhan Li \notcoe{(PhD student)}\hfill Spring 2021--current
}

\newcommand{\kimhao}{
\item \href{https://ndkimhao.github.io}{KimHao Nguyen} \notcoe{(BS, UNL)}\hfill graduated, May 2023
  \begin{description}[before=\small]
...
\newcommand{\guolong}{
\item Guolong Zheng \notcoe{(PhD, UNL)}\hfill graduated, May 2022
\begin{description}[before=\small]
...
\newcommand{\didier}{
\item Didier Ishimwe \notcoe{(PhD student, All but dissertation)}\hfill Fall 2019--current
%%   \begin{itemize}[before=\small]
...
\newcommand{\haiduong}{
\item Hai Duong \notcoe{(PhD student)}\hfill Fall 2022--current
  % \begin{itemize}[before=\small]
...
\newcommand{\nguyenkhoi}{
\item Nguyen Khoi \notcoe{(PhD student)}\hfill Fall 2024--current
%%   \begin{itemize}[before=\small]
...
%  Graduated one PhD student (in 2022). Have worked with 12 total undergraduate students.
  ...
  \item \textbf{Undergraduate Research}:
    \begin{itemize}
    \item GMU: James (Phat) Nguyen; Phuong Priscilla Nguyen (Undergraduate, Boston University); Michael Vittori
...
\begin{itemize}
\item Panelist, NSF Proposal Review Panel\hfill 2019-- (at least once \emph{every year})
\end{itemize}
...
\coe{
  ...
  % \subsubsection{Service Awards (Int.)}
...
\newcommand{\myunitservices}{
  \begin{itemize}
    ...
    \item Member, Web Committee\hfill 2022--current
          \begin{itemize}
                  \item CS Web Site Migration Committee\hfill 2024
          \end{itemize}
  ...
  \item Member, General Search Committee\hfill 2019--2020
...
\begin{itemize}
\item  Interviewer, Vietnamese Education Foundation 2.0 (VEF2.0) Fellowship Program\hfill 2023
\begin{description}[before=\small]
