...
\begin{itemize}
    ...
    \begin{itemize}
        \item Associate Prof. (tenured)\hfill 2024--current
        \item \emph{Program Director}, MS in Software Engineering\hfill 2023--current
        \item Assistant Prof. \hfill 2021--2024
        
    \end{itemize}
    
    \item Assistant Prof., Computer Science \& Engineering, \href{https://computing.unl.edu}{University of Nebraska-Lincoln} (UNL)\hfill 2016--2021
...
\begin{itemize}
  \item \textbf{NeuralSAT}: A high-performance verification tool for Deep Neural Networks. \url{github.com/dynaroars/neuralsat}
    \begin{itemize}[before=\small]
   ...
   \item \textbf{DIG}: A Dynamic and Symbolic Invariant Generation Tool for C programs. \url{github.com/dynaroars/dig}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{description}[before=\small]
        \item Enroll 28, Resp 20, Instr. Rating 4.2, Course Rating  4.2
    \end{description}
    \item \swe{619}\hfill Spring'24
    \begin{description}[before=\small]
        \item Enroll 28, Resp 25, Instr. Rating 4.4, Course Rating 4.6
    \end{description}
    
    \item CS 695/SWE 699 (Seminar): AI Safety and Assurance$^{\dagger}$\hfill Fall'23
    \begin{description}[before=\small]
        \item Enroll 29, Resp 24, Instr. Rating 4.8,  Course Rating 4.7
    \end{description}
  ...
  \item SWE 619 Online Course Development$^{\dagger}$ \hfill Fall'22
    ...
    \begin{description}[before=\small]
        \item Enroll 16, Resp 16, Instr. Rating 4.4, Course Rating 4.5
    \end{description}
    
    \item \swe{619}\hfill Spring'22
    \begin{description}[before=\small]
        \item Enroll 33, Resp 17, Instr. Rating 4.3, Course Rating 4.3
    \end{description}

  \item \swe{619}\hfill Fall'21
    \begin{description}[before=\small]
        \item Enroll 32, Resp 7, Instr. Rating 3.86, Course Rating 3.86 (Online class due to COVID)
    \end{description}
...
\begin{itemize}
    \item Review Panelist, NSF\hfill 2019--current (\emph{total 9 panels, at least once every year since 2019})
...
\begin{itemize}
    \item Member, Faculty Senate, representing the College of Engineering and Computing (CEC)\hfill 2024--current    
